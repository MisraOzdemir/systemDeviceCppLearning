/*
 *  This program has three limitations:
 *  1. It manipulates system TIDs as long integer values
 ...
 *  3. It does not protect the output phase, i.e., the output sections are critical
 *     sections as they can run in parallel, and the output of the different
